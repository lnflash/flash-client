...
const lnUrlInvoice = "lnurl1dp68gurn8ghj7mrw9e3xjarrda5kucn9v93kstnrdakj7tnhv4kxctttdehhwm30d3h82unvwqhhxctdv4eqztzfux";
...
const lnInvoice = "";
const lntbInvoice = "lntb1m1pd2awsppp54q20f42rpuzapqpxl4l5a2vhrm89pth7rj0nv3fyqvkl89hc8myqdqqcqzysms67f23xktazlazsjdwvqv7j59c34q5vqp4gnmddpkmlwqpufecxf9ledyq0ma495wrak26nvq5qcg6lgw7zwfy5yq4w54ux7qay3tsqrg02mh";
const lnbcrtInvoice = "";
const expiredLNInvoice = "LNBC11245410N1P05Z2LTPP52W2GX57TZVLM09SWZ8M0CAWGQPVTL3KUWZA836H5LG6HK2N2PRYQDPHXYSV89EQYVMJQSNFW3PXCMMRDDZXJMNWV4EZQST4VA6HXAPQXGU8G6QCQZPGXQRRSSVS7S2WT4GX90MQC9CVMA8UYDSTX5P0FA68V03U96HQDPFCT9DGDQQSENNAAGAXND6664CTKV88GMQ689LS0J7FFAD4DRN6SPLXAXZ0CQYZAU9Q";
const cashappInvoiceQR = "bitcoin:BC1Q5J58AAKAJGNZ78W2924WAJKGQLPS5CT6QXGR5E?amount=0.00025177&lightning=";
const btcpayServerQR = "bitcoin:BC1QUZ8NQRJ3UX86QEHT4F6QQNC75XMNRGCE06ASCH?amount=0.00025885&pj=https://pay.pavlenex.com/BTC/pj&lightning=";
const checkOnChain = (address, network) => {
    const destination = (0, _1.parsePaymentDestination)({
        destination: address,
        network,
        lnAddressDomains: [],
    });
    if (destination.paymentType !== _1.PaymentType.Onchain) {
...
describe("parsePaymentDestination validations", () => {
    it("classifies empty input as unknown", () => {
        const result = (0, _1.parsePaymentDestination)({
            destination: "",
            network: "mainnet",
            lnAddressDomains: [],
        });
        expect(result.paymentType).toBe(_1.PaymentType.NullInput);
    });
    it("validates an lnurl destination", () => {
        ...
        expect(result).toEqual(expect.objectContaining({
            paymentType: _1.PaymentType.Lnurl,
            valid: true,
            lnurl: lnUrlInvoice,
        }));
    });
    ...
    it("validates an internal lightning address", () => {
        ...
        expect(result).toEqual(expect.objectContaining({
            paymentType: _1.PaymentType.Intraledger,
            handle: "username",
        }));
    });
...
describe("parsePaymentDestination OnChain", () => {
    ...
    it("validates an onchain destination with amount ", () => {
        ...
        const paymentDestination = (0, _1.parsePaymentDestination)({
            destination: addressAmount,
            network: "mainnet",
            lnAddressDomains: [],
        });
        expect(paymentDestination).toEqual(expect.objectContaining({
            paymentType: _1.PaymentType.Onchain,
            valid: true,
            amount: 122000,
        }));
    });
    ...
    it("validates an onchain destination with a message", () => {
        const addressMessage = "bc1qdx09anw82zhujxzzsn56mruv8qvd33czzy9apt?message=test%20message";
        const paymentDestination = (0, _1.parsePaymentDestination)({
    ...
    it("returns the label as the memo when label and message are both present", () => {
        const addressLabelAndMessage = "bc1qdx09anw82zhujxzzsn56mruv8qvd33czzy9apt?label=test%20label&message=test%20message";
        const paymentDestination = (0, _1.parsePaymentDestination)({
    ...
    it("validates an onchain destination with a prefix", () => {
        const prefixAddress = "bitcoin:bc1qdx09anw82zhujxzzsn56mruv8qvd33czzy9apt?amount=0.00122";
        const paymentDestination = (0, _1.parsePaymentDestination)({
...
describe("parsePaymentDestination Lightning", () => {
    it("invalidates a mainnet invoice on signet", () => {
        ...
        expect(paymentDestination).toEqual(expect.objectContaining({
            valid: false,
            paymentType: _1.PaymentType.Lightning,
            invalidReason: _1.InvalidLightningDestinationReason.WrongNetwork,
        }));
    });
    ...
    it("detects a lightning param in an onchain address 1", () => {
        ...
        const address = "bitcoin:bc1qylh3u67j673h6y6alv70m0pl2yz53tzhvxgg7u?amount=0.00001&label=sbddesign%3A%20For%20lunch%20Tuesday&message=For%20lunch%20Tuesday&lightning=";
        const paymentDestination = (0, _1.parsePaymentDestination)({
            destination: address,
            network: "mainnet",
            lnAddressDomains: [],
        ...
        expect(paymentDestination).toEqual(expect.objectContaining({
            valid: true,
            paymentRequest: "",
            paymentType: _1.PaymentType.Lightning,
        }));
    });
    it("detects a lightning param in an onchain address 2", () => {
        ...
        expect(paymentDestination).toEqual(expect.objectContaining({
            valid: true,
            paymentRequest: "",
            paymentType: _1.PaymentType.Lightning,
        }));
    });
    it("detects a lightning param in an onchain address 3", () => {
        ...
        expect(paymentDestination).toEqual(expect.objectContaining({
            valid: true,
            paymentRequest: "",
            paymentType: _1.PaymentType.Lightning,
        }));
    });
...
describe("parsePaymentDestination IntraLedger handles", () => {
    ...
    it("validates a handle with flag", () => {
        ...
        expect(paymentDestination).toEqual(expect.objectContaining({
            paymentType: _1.PaymentType.IntraledgerWithFlag,
            handle: "Nakamoto",
            flag: "usd",
        }));
    });
    it("validates a handle with invalid flag", () => {
        ...
        expect(paymentDestination).toEqual(expect.objectContaining({
            paymentType: _1.PaymentType.Unknown,
            valid: false,
        }));
    });
    ...
    it("validates an http handle with invalid domain", () => {
        ...
        expect(paymentDestination).toEqual(expect.objectContaining({
            valid: false,
            paymentType: _1.PaymentType.Intraledger,
            invalidReason: _1.InvalidIntraledgerReason.WrongDomain,
        }));
    });
...
describe("parsePaymentDestination Merchant QR", () => {
    it("validates a merchant QR code on mainnet", () => {
        const merchantQR = "00020129530023za.co.electrum.picknpay.za.co.ecentric0122RD2HAK3KTI53EC/confirm520458125303710540115802ZA5916cryptoqrtestscan6002CT63049BE2";
        const paymentDestination = (0, _1.parsePaymentDestination)({
        ...
        expect(paymentDestination).toEqual(expect.objectContaining({
            paymentType: _1.PaymentType.Lnurl,
            valid: true,
            lnurl: "00020129530023za.co.electrum.picknpay.za.co.ecentric0122RD2HAK3KTI53EC%2Fconfirm520458125303710540115802ZA5916cryptoqrtestscan6002CT63049BE2@cryptoqr.net",
        }));
    });
    it("validates a merchant QR code on signet", () => {
        ...
        expect(paymentDestination).toEqual(expect.objectContaining({
            paymentType: _1.PaymentType.Lnurl,
            valid: true,
            lnurl: "00020129530023za.co.electrum.picknpay.za.co.ecentric0122RD2HAK3KTI53EC%2Fconfirm520458125303710540115802ZA5916cryptoqrtestscan6002CT63049BE2@staging.cryptoqr.net",
        }));
    });
});
